//include guards are preprocessor directives, ensures that a header is only included once, to avoid redefinition error

#ifndef KEYCONSTANTS_H //if not defined, then say what is not defined
...
class Keys {
    //we will use this class in order to store a map of keys that we get from the system and translate them to something closer to our understanding
